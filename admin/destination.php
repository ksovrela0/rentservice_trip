							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 <div class="input text"><label for="UserEmail">დასახელება eng</label><input name="name_eng" type="text" value="'.$ProductRow3['city_eng'].'" id="UserEmail"/></div>
									 <div class="input text"><label for="UserEmail">დასახელება RUS</label><input name="name_rus" type="text" value="'.$ProductRow3['city_rus'].'" id="UserEmail"/></div>
									...
									<div class="input text"><img src="'.$ProductRow3[pic1].'" height="240" width="120"></div>
									 ...
									 <div class="input text"><label for="UserDateOfBirth">სურათი 6(<a href="?edit='.$id.'&d=7" style="color:red;">წაშლა</a>)</label><input name="img6" type="file" accept="image/*" id="UserUsername"/></div>
									 
									 <div class="input text"><img src="'.$ProductRow3[pic7].'" height="240" width="120"></div>
									 <div class="input text"><label for="UserDateOfBirth">სურათი 7(<a href="?edit='.$id.'&d=8" style="color:red;">წაშლა</a>)</label><input name="img7" type="file" accept="image/*" id="UserUsername"/></div>
									 
									 <div class="input text"><img src="'.$ProductRow3[pic8].'" height="240" width="120"></div>
									 <div class="input text"><label for="UserDateOfBirth">სურათი 8(<a href="?edit='.$id.'&d=9" style="color:red;">წაშლა</a>)</label><input name="img8" type="file" accept="image/*" id="UserUsername"/></div>
									 
									 <div class="input text"><img src="'.$ProductRow3[pic9].'" height="240" width="120"></div>
									 <div class="input text"><label for="UserDateOfBirth">სურათი 9(<a href="?edit='.$id.'&d=10" style="color:red;">წაშლა</a>)</label><input name="img9" type="file" accept="image/*" id="UserUsername"/></div>
									 
									 <div class="input text"><img src="'.$ProductRow3[pic10].'" height="240" width="120"></div>
									 <div class="input text"><label for="UserDateOfBirth">სურათი 10(<a href="?edit='.$id.'&d=11" style="color:red;">წაშლა</a>)</label><input name="img10" type="file" accept="image/*" id="UserUsername"/></div>
									 
									 <div class="input text"><img src="'.$ProductRow3[pic11].'" height="240" width="120"></div>
									 <div class="input text"><label for="UserDateOfBirth">სურათი 11(<a href="?edit='.$id.'&d=12" style="color:red;">წაშლა</a>)</label><input name="img11" type="file" accept="image/*" id="UserUsername"/></div>
									
									<div class="input text"><img src="'.$ProductRow3[pic12].'" height="240" width="120"></div>
									 <div class="input text"><label for="UserDateOfBirth">სურათი 12(<a href="?edit='.$id.'&d=13" style="color:red;">წაშლა</a>)</label><input name="img12" type="file" accept="image/*" id="UserUsername"/></div>
							...
							<div class="row-fluid">
								<div class="span12">
									...
									if(isset($_GET[yes]))
									{
										...
										if($DelProduct == true)
										{
											echo '<META HTTP-EQUIV="REFRESH" CONTENT="0; URL=destination.php"><h2 style="color:green;"><b>PRODUCT '.$ProductRow2[title].' წაშლილია</b></h2>';
	...
	echo '<div class="row-fluid ">
				<div class="span12">
					...
					<div class="widget-body">
						...
						<a href="#">სია</a>                </li>
								<li >
						<a href="destination.php?add">დამატება</a>                </li>
							</ul>
									 <br />
									 <div class="tab-content">
					...
					<div class="widget-body">
						<table class="table table-hover">
							...
							<tr>
											...
											<th>
											<a href="/users.php/index/sort:username/direction:asc">ქალაქი ENG</a>                                    </th>
											<th>
											<a href="/users.php/index/sort:username/direction:asc">ქალაქი RUS</a>                                    </th>
																<th>
										Actions                                </th>
