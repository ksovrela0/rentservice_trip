					...
					<div class="widget-body">
						<table class="table table-hover">
							...
							<tr>
											...
											<th>
											<a href="/users.php/index/sort:username/direction:asc">ქვეკატეგორია</a>                                    </th> 
											<th>
											<a href="/users.php/index/sort:username/direction:asc">ფასი</a>                                    </th>   
											<th>
											<a href="/users.php/index/sort:username/direction:asc">ფასდაკლება</a>                                    </th> 
						   ...
						   do
						   {
							   ...
							   echo "</td>";		
							   $getCatNa = mysql_query("SELECT * FROM category WHERE id='$ProductRow[catID]' LIMIT 1");
							   $getCatNaR = mysql_fetch_array($getCatNa);
							   echo "<td class=''>";
							   echo $getCatNaR[name_geo];
							   echo "</td>";
							   $getCatNaa = mysql_query("SELECT * FROM sub_category WHERE id='$ProductRow[scatID]' LIMIT 1");
							   $getCatNaaR = mysql_fetch_array($getCatNaa);
							   echo "<td class=''>";
							   echo $getCatNaaR[name_geo];
							   echo "</td>";
							   echo "<td class=''>".$ProductRow[price]."</td><td class=''>".$ProductRow[sale]."</td>";
