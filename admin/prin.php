...
<?
	...
	$Product3 = mysql_query("SELECT * FROM principe WHERE id='".$id."' LIMIT 1");
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 <br />';
									 echo '<form action="prin.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
									 
									 
									 <div class="input text"><label for="UserEmail">სათაური 1</label><input name="title1" type="text" value="'.$ProductRow3['title1'].'" id="UserEmail"/></div>
									  <div class="input text"><label for="UserEmail">ტექსტი 1</label><input style="width:750px;" name="text1" type="text" value="'.$ProductRow3['text1'].'" id="UserEmail"/></div>
									  <br><br>
									 <div class="input text"><label for="UserEmail">სათაური 2</label><input name="title2" type="text" value="'.$ProductRow3['title2'].'" id="UserEmail"/></div>
									  <div class="input text"><label for="UserEmail">ტექსტი 2</label><input style="width:750px;" name="text2" type="text" value="'.$ProductRow3['text2'].'" id="UserEmail"/></div>
									  <br><br>
									 <div class="input text"><label for="UserEmail">სათაური3</label><input name="title3" type="text" value="'.$ProductRow3['title3'].'" id="UserEmail"/></div>
									  <div class="input text"><label for="UserEmail">ტექსტი 3</label><input style="width:750px;" name="text3" type="text" value="'.$ProductRow3['text3'].'" id="UserEmail"/></div>
									 <br><br>
									 <div class="input text"><label for="UserEmail">სათაური 4</label><input name="title4" type="text" value="'.$ProductRow3['title4'].'" id="UserEmail"/></div>
									  <div class="input text"><label for="UserEmail">ტექსტი 4</label><input style="width:750px;" name="text4" type="text" value="'.$ProductRow3['text4'].'" id="UserEmail"/></div>
									  <br><br>
									 <div class="input text"><label for="UserEmail">სათაური 5</label><input name="title5" type="text" value="'.$ProductRow3['title5'].'" id="UserEmail"/></div>
									  <div class="input text"><label for="UserEmail">ტექსტი 5</label><input style="width:750px;" name="text5" type="text" value="'.$ProductRow3['text5'].'" id="UserEmail"/></div>
									  <br><br>
									 <div class="input text"><label for="UserEmail">სათაური 6</label><input name="title6" type="text" value="'.$ProductRow3['title6'].'" id="UserEmail"/></div>
									  <div class="input text"><label for="UserEmail">ტექსტი 6</label><input style="width:750px;" name="text6" type="text" value="'.$ProductRow3['text6'].'" id="UserEmail"/></div>									 
	...
	<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
									...
									if(isset($_POST['title1']) and isset($_POST['text1']) and isset($_POST['title2']) and isset($_POST['text2']) and isset($_POST['title3']) and isset($_POST['text3']))
									{
										$title1 = $_POST['title1'];
										$text1 = $_POST['text1'];
										...
										if(empty($title1) or empty($text1) or empty($title2) or empty($text2) or empty($title3) or empty($text3) or empty($title4) or empty($text4) or empty($title5) or empty($text5) or empty($title6) or empty($text6))
										{
											echo '<h2 style="color:red;"><b>თქვენ გამოტოვეთ საჭირო ველები!!!</b></h2>';
										}
										else
										{
												$UpdateProduct = mysql_query("UPDATE principe SET title1='$title1', text1='$text1',title2='$title2', text2='$text2',title3='$title3', text3='$text3',title4='$title4', text4='$text4',title5='$title5', text5='$text5',title6='$title6', text6='$text6' WHERE id='$id'") or die(mysql_error());
												...
												//echo '<META HTTP-EQUIV="REFRESH" CONTENT="0; URL=prin.php?edit=1">';
