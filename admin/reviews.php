...
<?
	...
	$Product2 = mysql_query("SELECT * FROM reviews WHERE id='".$id."'");
					...
					<div class="widget-body">
							<div class="row-fluid">
								<div class="span12">
									<!--BEGIN TABS-->
									<div class="table table-custom">
									 <h3>კომენტარი <b>'.$ProductRow2[name].' წაშლა</b></h3> 
									 <br />
										<div class="tab-content">
											Are you sure?<br> <a href="reviews.php?del='.$_GET[del].'&yes">Yes, of course</a><br><a href="reviews.php" style="color:red;">No</a>                                    </div>
									</div>
									</div></div></div></div></div></div>';
									if(isset($_GET[yes]))
									{
										$DelProduct = mysql_query("DELETE FROM reviews WHERE id='".$id."'");
										if($DelProduct == true)
										{
											echo '<META HTTP-EQUIV="REFRESH" CONTENT="0; URL=reviews.php"><h2 style="color:green;"><b>REVIEW '.$ProductRow2[name].' წაშლილია</b></h2>';
	...
	$Product3 = mysql_query("SELECT * FROM reviews WHERE id='".$id."'");
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 <br />';
									 echo '<form action="reviews.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
	...
	echo '<div class="row-fluid ">
				<div class="span12">
					...
					<div class="widget-body">
						...
						<a href="#">სია</a>                </li>
								<li >
						<a href="reviews.php?add">დამატება</a>                </li>
							</ul>
									 <br />
									 <div class="tab-content">
						...
						<table class="table table-hover">
							...
							<tr>
											...
											<a href="/users.php/index/sort:id/direction:asc" class="desc">Id</a>                                    </th>
																		<th>
											<a href="/users.php/index/sort:username/direction:asc">თარიღი</a>                                    </th>
											<th>
						   ...
						   $Product = mysql_query("SELECT * FROM reviews ORDER BY id DESC") or die(mysql_error());
						   $ProductRow = mysql_fetch_array($Product);
						   do
						   {
							   echo "<tr><td class=''>".$ProductRow[id]."</td><td class=''>";
							   echo $ProductRow[date];
							   echo "</td>";		
