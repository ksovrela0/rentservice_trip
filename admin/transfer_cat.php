...
<?
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 echo '</h3> 
									 <br />';
									 echo '<form action="transfer_cat.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
	...
	<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
									if(isset($_POST['name_geo']))
									{
										...
										else
										{
												...
												echo '<META HTTP-EQUIV="REFRESH" CONTENT="0; URL=transfer_cat.php">';
	...
	$Product2 = mysql_query("SELECT * FROM prepared_transfers WHERE id='".$id."'");
									...
									<div class="table table-custom">
									 ...
									 <br />
										<div class="tab-content">
											Are you sure?<br> <a href="transfer_cat.php?del='.$_GET[del].'&yes">Yes, of course</a><br><a href="slider.php" style="color:red;">No</a>                                    </div>
									</div>
									</div></div></div></div></div></div>';
									if(isset($_GET[yes]))
									{
										$DelProduct = mysql_query("DELETE FROM prepared_transfers WHERE id='".$id."'");
										if($DelProduct == true)
										{
											echo '<META HTTP-EQUIV="REFRESH" CONTENT="0; URL=transfer_cat.php"><h2 style="color:green;"><b>'.$ProductRow2[title].' წაშლილია</b></h2>';
	...
	$Product3 = mysql_query("SELECT * FROM prepared_transfers WHERE id='".$id."'");
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 <br />';
									 echo '<form action="transfer_cat.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
	...
	<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
									...
									if(isset($_POST['name_geo']))
									{
										...
										{
												$UpdateProduct = mysql_query("UPDATE prepared_transfers SET name_rus='$name_rus', name_geo='$name_geo', name_eng='$name_eng'WHERE id='$id'") or die(mysql_error());
	...
	echo '<div class="row-fluid ">
				<div class="span12">
					...
					<div class="widget-body">
						...
						<a href="#">სია</a>                </li>
								<li >
						<a href="transfer_cat.php?add">დამატება</a>                </li>
							</ul>
									 <br />
									 <div class="tab-content">
				...
				<div class="widget">
					...
					<div class="widget-body">
						<table class="table table-hover">
						   ...
						   $Product = mysql_query("SELECT * FROM prepared_transfers ORDER BY id DESC") or die(mysql_error());
