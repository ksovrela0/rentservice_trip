...
<?
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 echo'</h3> 
									 <br />';
									 echo '<form action="slider.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
	...
	$Product2 = mysql_query("SELECT * FROM slider WHERE id='".$id."'");
					...
					<div class="widget-body">
							<div class="row-fluid">
								<div class="span12">
									<!--BEGIN TABS-->
									<div class="table table-custom">
									 <h3>სლაიდერი <b>'.$ProductRow2[name_geo].' წაშლა</b></h3> 
									 <br />
										<div class="tab-content">
											Are you sure?<br> <a href="slider.php?del='.$_GET[del].'&yes">Yes, of course</a><br><a href="slider.php" style="color:red;">No</a>                                    </div>
									</div>
									</div></div></div></div></div></div>';
									if(isset($_GET[yes]))
									{
	...
	if(isset($_GET['edit']) and !empty($_GET['edit']))
	{
		...
		if(isset($_GET[d]))
		{
			...
			if($d == '1')
			{
				$Up = mysql_query("UPDATE slider SET pic1='' WHERE id='$id'");
			}
		}
					...
					<div class="widget-body">
							<div class="row-fluid">
								<div class="span12">
									<!--BEGIN TABS-->
									<div class="table table-custom">
									 <h3>რედაქტირება <b>'.$ProductRow3[id].'</b></h3> 
									 <br />';
	...
	echo '<div class="row-fluid ">
				<div class="span12">
					...
					<div class="widget-body">
						...
						<a href="#">სია</a>                </li>
								<li >
						<a href="slider.php?add">დამატება</a>                </li>
							</ul>
									 <br />
									 <div class="tab-content">
