...
<?
	...
	$Product3 = mysql_query("SELECT * FROM three WHERE id='".$id."' LIMIT 1");
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 <br />';
									 echo '<form action="three.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
	...
	<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
									...
									if(isset($_POST['title1']) and isset($_POST['text1']) and isset($_POST['title2']) and isset($_POST['text2']) and isset($_POST['title3']) and isset($_POST['text3']))
									{
										...
										if(empty($title1) or empty($text1) or empty($title2) or empty($text2) or empty($title3) or empty($text3))
										{
											echo '<h2 style="color:red;"><b>თქვენ გამოტოვეთ საჭირო ველები!!!</b></h2>';
										}
										else
										{
												$UpdateProduct = mysql_query("UPDATE three SET title1='$title1', text1='$text1',title2='$title2', text2='$text2',title3='$title3', text3='$text3' WHERE id='$id'") or die(mysql_error());
												...
												//echo '<META HTTP-EQUIV="REFRESH" CONTENT="0; URL=three.php?edit=1">';
