...
<?
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 <h3>';
										echo 'ტრანსფერის კატეგორიის დამატება';
									 echo '</h3> 
									 <br />';
	...
	$Product2 = mysql_query("SELECT * FROM transfer_locations WHERE id='".$id."'");
									...
									<div class="table table-custom">
									 ...
									 <br />
										<div class="tab-content">
											Are you sure?<br> <a href="transfer.php?del='.$_GET[del].'&yes">Yes, of course</a><br><a href="slider.php" style="color:red;">No</a>                                    </div>
									</div>
									</div></div></div></div></div></div>';
									if(isset($_GET[yes]))
									{
										$DelProduct = mysql_query("DELETE FROM transfer_locations WHERE id='".$id."'");
										if($DelProduct == true)
										{
											echo '<META HTTP-EQUIV="REFRESH" CONTENT="0; URL=transfer.php"><h2 style="color:green;"><b>'.$ProductRow2[title].' წაშლილია</b></h2>';
	...
	$Product3 = mysql_query("SELECT * FROM transfer_locations WHERE id='".$id."'");
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 <br />';
									 echo '<form action="transfer.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
	...
	<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
									...
									if(isset($_POST['tranfer_cat']))
									{
										...
										{
												$UpdateProduct = mysql_query("UPDATE transfer_locations SET start_location='$loc_start', end_location='$loc_end', transfer_id='$tranfer_cat' WHERE id='$id'") or die(mysql_error());
	...
	echo '<div class="row-fluid ">
				<div class="span12">
					...
					<div class="widget-body">
						...
						<a href="#">სია</a>                </li>
								<li >
						<a href="transfer.php?add">დამატება</a>                </li>
							</ul>
									 <br />
									 <div class="tab-content">
				...
				<div class="widget">
					...
					<div class="widget-body">
						<table class="table table-hover">
						   ...
						   $Product = mysql_query(" SELECT  transfer_locations.id,
                                                                    prepared_transfers.name_geo,
                                                                    start_l.name_geo AS start_loc,
                                                                    end_l.name_geo AS end_loc
                                                                    
                                                    FROM    transfer_locations 
                                                    JOIN    prepared_transfers ON prepared_transfers.id = transfer_locations.transfer_id
                                                    LEFT JOIN	locations AS start_l ON start_l.id = transfer_locations.start_location
                                                    LEFT JOIN	locations AS end_l ON end_l.id = transfer_locations.end_location
                                                    ORDER BY transfer_locations.id ASC") or die(mysql_error());
						   $ProductRow = mysql_fetch_array($Product);
						   do
						   {
							   echo "<tr><td class=''>".$ProductRow[id]."</td><td class=''>".$ProductRow[name_geo]."</td><td class=''>".$ProductRow[start_loc]."</td><td class=''>".$ProductRow[end_loc]."</td>";
