...
<head>
    ...
    <link rel="stylesheet" href="css/styles.css?v=3.8">
    ...
    <div class="global-wrap">
            ...
            <div class="container">
                <div class="nav">
                    <ul class="slimmenu" id="slimmenu">
                        <li class="active"><a href="index.php">Трансфер</a>
                        </li>
                ...
                <div class="bg-front full-center">
                    <div class="container container-transfer">
                        <div class="search-tabs search-tabs-bg">
                            <h1>Спланировать маршрут</h1>
                            <div class="tabbable">
                                <ul class="nav nav-tabs" id="myTab">
                                    <li class="active"><a href="#tab-1" data-toggle="tab"><i class="fa fa-car"></i> <span >Трансфер</span></a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="add-destination-plus">
                                                        Добавить локацию <i class="fa fa-plus"></i>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-group-lg form-group-icon-left"><i class="fas fa-clock input-icon"></i>
                                                        <label>Кол-во дней бронирования</label>
                                                        <select class="form-control" id="trip_days">
                                                            <option value="0">Выберите кол-во дней бронирования</option>
                                                            <?php
                                                                for($i = 1; $i <= 30; $i++){
        ...
        <div class="container prepared_trip">
            ...
            <div class="prepared_states">
                <h3 class="text-center mb20 popular_destination">Популярные направления</h3>
                <?php
                    prepared_transfers();
                ?>
            </div>
        ...
        <div class="container cars_area" style="display:none; border-top: 1px solid black;border-radius: 40px; margin-top:10px;">
            <div class="trip_data">
                <div class="trip_distance">Длина Маршрута: <span class="changable_text" id="tripDistance">0</span> КМ</div>
                <div class="trip_duration">Продолжительность: <span class="changable_text" id="tripDuration">00:00</span> Час</div>
            </div>
            <div class="fleet_filter">
                <div class="fleet_type">
                    <ul class="car_types">
                        <li class="car_li actived" data-id="0"><i class="fa fa-car" aria-hidden="true" style="font-size: 36px;"></i>ВСЕ</li>
                        <li class="car_li" data-id="1"><img src="img/cartypes/sedan_t.png" >Седан</li>
                        <li class="car_li" data-id="2"><img src="img/cartypes/suv_t.png" >Внедорожник</li>
                        <li class="car_li" data-id="3"><img src="img/cartypes/minivan_t.png" >Минивэн</li>
                        <li class="car_li" data-id="4"><img src="img/cartypes/minibus_t.png" >Микроавтобус</li>
                    </ul>
                </div>
                
            </div>
            <div class="gap"></div>
            <h5 class="text-center mb20" style="font-weight:bold;color: #ffca18;">Цена включает полную стоимость поездки (а не стоимость одного пассажира).</h5>
        ...
        <script src="js/custom.js?v=2.6"></script>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Бронировать</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <input class="form-control cl_inputs" placeholder="Полное Имя" id="cl_fullname">
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <input class="form-control cl_inputs" placeholder="Телефон" id="cl_phone">
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <input class="form-control cl_inputs" placeholder="Адрес" id="cl_address">
                            </div>
                        </div>
                        <div class="col-md-12 col-xs-12">
                            <div class="form-group">
                                <textarea class="form-control cl_inputs" placeholder="Комментарий" id="cl_comment"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer" style="text-align:center!important;">
                    <button style="width:100%" type="button" class="btn btn-primary placeOrder">Бронировать</button>
                </div>
